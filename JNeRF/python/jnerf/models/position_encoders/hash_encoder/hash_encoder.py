...
#define get_index(p0,p1,p2) {self.hash_func}
        """
        self.encoder = GridEncode(self.hash_func_header, aabb_scale=aabb_scale, n_pos_dims=n_pos_dims, n_features_per_level=n_features_per_level,
                                  n_levels=n_levels, base_resolution=base_resolution, log2_hashmap_size=log2_hashmap_size, using_fp16=using_fp16)
